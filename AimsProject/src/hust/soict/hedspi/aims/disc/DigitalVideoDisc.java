...
public class DigitalVideoDisc {
    ...
    private static int nbDigitalVideoDiscsPhucNH = 0;
    private int idPhucNH;
    ...
    public DigitalVideoDisc(String titlePhucNgo) {
        ...
        this.idPhucNH = ++nbDigitalVideoDiscsPhucNH;
    }
    ...
    public DigitalVideoDisc(String titlePhucNgo, String categoryPhucNgo, String directorPhucNgo, int lengthPhucNgo,
     float costPhucNgo) {
        super(); 
        this.titlePhucNH = titlePhucNgo; // Initialize title
        this.categoryPhucNH = categoryPhucNgo; // Initialize category
    ...
    public String toString() {
        return "DVD: " + this.titlePhucNH +
                " - Category: " + this.categoryPhucNH +
                " - Director: " + this.directorPhucNH +
                " - DVD length: " + this.lengthPhucNH +
                " - Cost: " + this.costPhucNH + "$";
    }
